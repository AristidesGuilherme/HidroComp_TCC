...
class VonMises(DistributionBiuld):
    '''variable:
    ...
    def __init__(self, title, shape, location, scale, variable):
        super().__init__(title, shape, location, scale, variable)
    ...
    def cumulative(self):
        ...
        layout = dict(title="Von Mises - Acumulada: %s" % self.title,
                      showlegend=True,
    ...
    def density(self):
        ...
        layout = dict(title="Von Mises - Densidade: %s" % self.title,
                      showlegend=True,
                      width=945, height=827,
                      xaxis=bandxaxis,
                      yaxis=bandyaxis,
